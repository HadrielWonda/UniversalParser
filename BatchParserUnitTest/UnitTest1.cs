...
{
    [TestClass]
    public class UnitTest1 : UniversalParser.NET.Tools.BatchFile
    {
        [TestMethod]
        public void TestMethod1()
        {
            string data1 = @"[alireza,p,0010000000,24,http://github.com/HadrielWonda][ali,pari,0010000230,25,http://nuget.org/HadrielWonda]";
  ...
  <record StartWith = ""["" EndWith = ""]"" />
     ...
     <FIELD5 ID = ""5"" Type = ""string"" Title = ""url"" TERMINATOR = ""]"" MAX_LENGTH = ""50"" />
            ...
            Assert.AreEqual("http://github.com/HadrielWonda", res[0].url);
            ...
            Assert.AreEqual("http://nuget.org/HadrielWonda", res[1].url);
        }
  ...
  <record StartWith = """" EndWith = """" />
     ...
     <FIELD5 ID = ""5"" Type = ""string"" Title = ""url"" TERMINATOR = "","" MAX_LENGTH = ""50"" />
        ...
        {
            string data1 = @"alireza,p,0010000000,24,http://github.com/HadrielWonda"
+Environment.NewLine+
@"ali,pari,0010000230,25,http://nuget.org/HadrielWonda"+ Environment.NewLine;
